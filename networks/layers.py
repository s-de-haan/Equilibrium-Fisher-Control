...
class DFC_layer(Layer):
    def __init__(self, in_features, out_features, activation_fn, config, name="DFC_layer"):
        super(DFC_layer, self).__init__(in_features, out_features, activation_fn, config, name)
